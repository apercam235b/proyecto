...
class CameraCapture:
    def __init__(self):
        self.capture = None
 # Generamos una funcion que defina capturar la imagen
    def take_photo(self):
        ...
        if ret:
            ...
            return False
 #Lanzamos la libreria que ejecuta la captura de fotos
capture = CameraCapture()
 #Lanzamos la llamada a FLASK
